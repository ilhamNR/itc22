...
$routes->get('/lolos/(:num)', 'AuthController::lolos/$1',['filter' => 'auth']);
$routes->get('/tdklolos/(:num)', 'AuthController::tdkLolos/$1',['filter' => 'auth']);
$routes->get('/refreshToken', 'Data::refreshToken');
$routes->get('/exportData/(:num)', 'MasterEventController::exportData/$1');
//Admin
