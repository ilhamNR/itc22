            ...
            <div class="flex-auto px-0 pt-0 pb-2">
                <form action="/admin/masterusers/<?= $masterUser['id']?>" method="post">
                    <div class="p-6 overflow-x-auto">
                        ...
                        <?php }?>
                        <p>Email</p>
                        <input type="email" value="<?= $masterUser['email']?>" name="email" placeholder="Ex: rano@myrelasi.id" class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none">
