...
<div class="flex flex-wrap -mx-3">
        ...
        <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
            ...
            <div class="flex-auto px-0 pt-0 pb-2">
                <form action="/admin/masterevents/<?= $masterEvent['id']?>" method="post">
                    <div class="p-6 overflow-x-auto">
                        <p>Judul</p>
                        <input type="text" value="<?= $masterEvent['title']?>" name="judul" placeholder="Ex: Workshop Day #1" class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none">
